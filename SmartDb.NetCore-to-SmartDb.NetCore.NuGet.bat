...
xcopy "%SouceDir%\SmartDb.NetCore\SqlBuilder.cs"  "%DestDir%\SmartDb.NetCore\" /s /r /c /v /y
xcopy "%SouceDir%\SmartDb.NetCore\SqlDbContext.cs"  "%DestDir%\SmartDb.NetCore\" /s /r /c /v /y
xcopy "%SouceDir%\SmartDb.NetCore\SqlDbFactory.cs"  "%DestDir%\SmartDb.NetCore\" /s /r /c /v /y
...
:: copy TestSmartDbConsole All Files
xcopy "%SouceDir%\TestSmartDbConsole\*.cs"  "%DestDir%\TestSmartDbConsole\" /s /r /c /v /y
